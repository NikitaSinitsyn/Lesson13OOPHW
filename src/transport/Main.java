...
public class Main {
    public static void main(String[] args) {
        ...
        Car car1 = new Car("Lada", "Granta", 2015, "Россия", "желтый",  1.7f, driverB1, "механика", "хэчбэк", "C227HA48", 5, true, new Car.Key(true, true), 45, 245, 240);
        Car car2 = new Car("Audi", "A8 50 l TDI quattro", 2020, "Германия", "черный",  3.0f, driverB2, "автомат", "купэ", "C227HA48", 5, true, new Car.Key(true, true), 52, 252, 230);
        Car car3 = new Car("BMW", "Z8", 2021, "Германия", "черный",  3.0f, driverB3, "автомат", "хэчбэк", "C227HA48", 5, true, new Car.Key(true, true), 53, 235, 235);
        Car car4 = new Car("Kia", "Sportage 4-го поколения", 2015, "Южная Коррея", "красный",  2.4f, driverB4, "автомат", "купэ", "C227HA48", 5, true, new Car.Key(true, true), 42, 247, 242);
        Car car5 = new Car("Hyundai", "Avante", 2016, "Южная Коррея", "оренжевый",  2.5f, driverB5, "автомат", "универсал", "C227HA48", 5, true, new Car.Key(true, true), 43, 245, 220);
        ...
        Bus firstBus = new Bus("Hyundai", "Universe", 2020, "Южная Коррея", "белый",  4.2f, driverC1, 45, 238, 220);
        Bus secondBus = new Bus("Kia", "Granbird Silkroad", 2021, "Южная Коррея", "серый", 5.0f, driverC2, 42, 250, 210);
        Bus thirdBus = new Bus("Volvo", "9900", 2022, "Швеция", "белый",  5.3f, driverC3, 41, 242, 209);
        Bus fourthBus = new Bus("Mercedes-Benz", "Sprinter", 2006, "Германия", "Серый",  3.0f, driverC4, 44, 243, 214);
        ...
        Truck firstTruck = new Truck("MAN", "TGX", 2020,"Германия", "Серый",  4.2f, driverD1, 45, 241, 218);
        Truck secondTruck = new Truck("MAN", "TGS", 2021,"Германия", "Серый",  5.0f, driverD2, 42, 243, 215 );
        Truck thirdTruck = new Truck("Volvo", "FN16", 2020,"Швеция", "Серый",  5.2f, driverD3, 41, 245, 212 );
        Truck fourthTruck = new Truck("Hyundai", "Xcient", 2021,"Южная Коррея", "Серый",  4.0f, driverD4, 45, 246, 210 );
