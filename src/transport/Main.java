...
public class Main {
    public static void main(String[] args) {
        ...
        Car car3 = new Car("BMW", "Z8", 2021, "Германия", "черный",  3.0f, driverB1, "автомат", BodyType.Hatchback, "C227HA48", 5, true, new Car.Key(true, true), 53, 235, 235, CarType.FourStrokeSupercharged);
        ...
        Bus firstBus = new Bus("Hyundai", "Universe", 2020, "Южная Коррея", "белый",  4.2f, driverC1, 45, 238, 220, CapacityType.VerySmall, BusType.Passenger);
        Bus secondBus = new Bus("Kia", "Granbird Silkroad", 2021, "Южная Коррея", "серый", 5.0f, driverC2, 42, 250, 210, CapacityType.Small, BusType.Passenger);
        Bus thirdBus = new Bus("Volvo", "9900", 2022, "Швеция", "белый",  5.3f, driverC3, 41, 242, 209, CapacityType.Middle, BusType.Passenger);
        Bus fourthBus = new Bus("Mercedes-Benz", "Sprinter", 2006, "Германия", "Серый",  3.0f, driverC4, 44, 243, 214, CapacityType.Middle, BusType.Passenger);
        ...
        Truck firstTruck = new Truck("MAN", "TGX", 2020,"Германия", "Серый",  4.2f, driverD1, 45, 241, 218, LoadCapacity.N1, TruckType.ClosedBody);
        Truck secondTruck = new Truck("MAN", "TGS", 2021,"Германия", "Серый",  5.0f, driverD2, 42, 243, 215, LoadCapacity.N2, TruckType.ClosedBody );
        Truck thirdTruck = new Truck("Volvo", "FN16", 2020,"Швеция", "Серый",  5.2f, driverD3, 41, 245, 212, LoadCapacity.N1, TruckType.ClosedBody );
        Truck fourthTruck = new Truck("Hyundai", "Xcient", 2021,"Южная Коррея", "Серый",  4.0f, driverD4, 45, 246, 210, LoadCapacity.N3, TruckType.ClosedBody);
